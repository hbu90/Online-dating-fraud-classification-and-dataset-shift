...
from ml_tesseract import utils as utils, metrics as metrics
...
def fit_predict_update(clf, X_train, X_tests,
    ...
    for i, (X_test, y_test, t_test) in tqdm(enumerate(
        ...
        if selected_indexes is not None:
            ...
            t_selected = np.array(t_test)[selected_indexes]
            ...
            X_train = scipy.sparse.vstack((X_train, X_selected)).toarray()
